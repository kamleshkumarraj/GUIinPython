...
frame1.place(x=100,y=5,height=300)
lb1=Label(frame1,text="******Print Reverse*******")
lb1.place(x=2,y=0)
x,y,b=120,100,1
a=b
y1=y
...
btn_arm=Button(root,text="Reverse",bg="cyan",activebackground="green",bd=8,width=8)
btn_arm.place(x=200,y=250,height=40)
btn_arm.bind("<Button-1>",get_number)
btn_clear=Button(root,text="Clear",bg="cyan",activebackground="green",bd=8,width=8)
btn_clear.place(x=280,y=250,height=40)
